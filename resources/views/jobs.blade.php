...
<html lang="en">
  ...
  <body>
    <section class="jobs-main-section d-flex flex-column">
        ...
        <div class="row mt-5">
          <div class="col-12 col-md-6 col-lg-4">
            <div class="card border-0 p-3 shadow-sm mb-4">
              <a href="#" class="mb-3">Customer Service</a>
              ...
              <ul class="mb-0 ps-3">
                <li>
                  Answering questions and inquiries that arrive through the
                  website or WhatsApp.
                </li>
                <li>
                  Explaining and clarifying the features of the service for
                  users.
                </li>
              </ul>
            </div>
